...
namespace ChatroomB_Backend.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPost("receiveUserIds")]
        public IActionResult ReceiveUserIds([FromBody] List<int> selectedUserIds)
        {
            // Process the received selectedUserIds here
            // For demonstration purposes, just return the received data
            return Ok(selectedUserIds);
        }
    }
}
