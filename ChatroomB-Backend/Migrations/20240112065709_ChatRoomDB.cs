        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomProfilePic = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileName = table.Column<string>(type: "nvarchar(15)", nullable: false),
                    Password = table.Column<string>(type: "varchar(256)", nullable: false),
                    ProfilePicture = table.Column<string>(type: "varchar(256)", nullable: true),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenHash = table.Column<string>(type: "varchar(256)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserChatRoomId = table.Column<int>(type: "int", nullable: true),
                    TimeStamp = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ResourceUrl = table.Column<string>(type: "varchar(256)", nullable: true),
                    MessageType = table.Column<int>(type: "int", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messages", x => x.MessengeId);
                    table.ForeignKey(
                        name: "FK_Messages_UserChatRooms_UserChatRoomId",
                        column: x => x.UserChatRoomId,
                        principalTable: "UserChatRooms",
                        principalColumn: "UserChatRoomId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_UserChatRoomId",
                table: "Messages",
